...
const MainMenu = ({language, callDocument, callBarcode, viewDocuments}) => {
    return (
        <>
            ...
            <div className='contentContainer'>
                ...
                <div className='footer'>
                    <p dangerouslySetInnerHTML={{ __html: `App version 1.4.0.60<br />Scanbot SDK version 1.78.0<br />© 2020 doo GmbH. All rights reserved.` }}/>
                </div>
            </div>
        </>
    )
